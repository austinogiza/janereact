...
<Team className=" mt-10 mb-10 py-4 px-4 flex flex-col max-w-6xl  mx-auto w-full h-auto min-h-0">

<Teamtitle className=" max-w-sm w-full mt-2 mb-5  min-h-0 h-full flex flex-col">
...
<Aboutcover className='max-w-7xl grid grid-cols-1 2xl:grid-cols-4 lg:grid-cols-4 xl:grid-cols-4 mt-10 mb-6 gap-5 mx-auto h-full max-h-72 '>
    ...
    <Aboutimage className='h-full flex flex-col max-h-72 max-w-xs'>
            ...
            <Aboutimg src="https://res.cloudinary.com/jane-s-fashion/image/upload/v1624313707/fe1cf7f2-a43c-46ee-8d31-9a3f455b5ac0_f8v97u.jpg" className=' px-2 py-2 max-h-64 h-full w-full'/>
